...
// ISTO AQUI É O CODIGO IMPORTANTE O RESTO É SO UTIL, MAS ISTO É A PARTE MAIS DIFICIL DE IMPLEMENTAR
// USAR A API DO C++ DO WINDOWS

// CRIAR UM ENUMERADOR DE DEVICES MULTIMEDIA
// USANDO O ENUMERADOR DOS DEVICES PARA ENCONTRAR O DEFAULT ENDPOINT 
// ATIVAR UM CLIENTE DE AUDIO PARA O ENDPOINT
// BUSCAR O FORMATO DE AUDIO DO CLIENTE DE AUDIO
// INICIALIZAR O CLIENTE DE AUDIO
// USANDO O CLIENTE DE AUDIO, USO UM RENDERER PARA PODER

// BUSCAR UM POINTER ASSEGUIR AO MEU BUFFER
// ESCREVER NO BUFFER USANDO A FUNÇÃO LA EM CIMAA
// DAR RELEASE E ATUALIZAR A POSIÇÃO DO PONTEIRO PARA O FIM DO BUFFER (PARA PROXIMAS UTILIZAÇÕES)´

// ESPERAR ATE MEIO DO BUFFER PASSAR
// PREENCHER METADE DO BUFFER COMO DESCRITO ACIMA
// REPETIR ESTE LOOP BUE VEZES ATE (ACABAR O TEMPO)
